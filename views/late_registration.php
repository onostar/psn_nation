...
<meta charset="UTF-8">
    ...
    <title>Jewel city 2023| Late registration</title>
...
<body>
    ...
    <main>
        ...
        <!-- <hr> -->
        <P id="p" style="text-align:center;"> Late Registration</P>
        <div class="details_form">
            
                <div class="management displays" style="display:block" id="profile">
                    <div class="info"></div>
                    <div class="add_user_form">
                        <h3 style="text-align:center">Register your details</h3>
                        <form method="POST"  id="addCatForm" action="../controller/late_delegate_reg.php" enctype="multipart/form-data">
                            <div class="inputs">
                                <div class="data">
                                    <label for="pcn_number">PCN Number</label>
                                    <input type="text" name="pcn_number" id="pcn_number">
                                </div>
                                <div class="data">
                            ...
                            <div class="inputs">
                                ...
                                <div class="data">
                                    ...
                                    <input type="tel" name="other_number" id="other_number">
                                </div>
                            </div>
                            <div class="inputs">
                                <div class="data">
                            ...
                            <div class="inputs">
                                ...
                                <div class="update_btn data">
                                    <button type="submit" id="register" name="register">Register <i class="fas fa-user"></i></button>
                                </div>
                            </div>
