    ...
    <nav>
        ...
        <ul>
            ...
            ?>
            <li><a href="javascript:void(0);" id="addCat" title="Upload payment" class="page_navs" data-page="addCategories" onclick="showPage('upload_payment.php')"><i class="fas fa-paper-plane"></i>Upload payment</a></li>
            <?php }?>
            <?php
            ...
            ?>
            <li><a href="javascript:void(0);" id="addMenu" title="Request accomodation" class="page_navs" onclick="showPage('accomodations.php')"><i class="fas fa-hotel"></i> View Accomodations</a></li>
            <!-- <li><a href="javascript:void(0);" id="addMenu" title="Request accomodation" class="page_navs" onclick="showPage('request_accomod.php')"><i class="fas fa-hotel"></i> Request Accomodation</a></li> -->
            <?php }?>
            <?php
                $get_request = $connectdb->prepare("SELECT * FROM request_hotel WHERE requester = :requester");
                $get_request->bindvalue("requester", $user->pcn_number);
                $get_request->execute();
            ...
            <?php
                ...
                $get_bulk->bindvalue("requester", $user->pcn_number);
                $get_bulk->execute();
