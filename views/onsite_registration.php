...
<meta charset="UTF-8">
    ...
    <title>Jewel city 2023 conference | Onsite Registration</title>
    ...
    <main>
            <section class="reg_log">
                ...
                <?php include "sponsors_display.php"?>
                    ...
                    ?>
                    <form action="../controller/onsite_register.php" method="POST" enctype="multipart/form-data" class="form">
                    <div class="input">
                        <div class="data">
                        ...
                        <div class="data">
                            <input type="hidden" name="pcn_number" id="pcn_number" value="000" placeholder="PCN Number" required>
                        </div>
                        <div class="data">
                        ...
                        <div class="data" id="guest_password">
                    ...
                    <div class="signup_option">
                        <!-- <p>Already have an account? <a href="guest_login.php">Login now</a></p> -->
                    </div>
                    <div id="foot">
