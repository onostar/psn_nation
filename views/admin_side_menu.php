<aside class="main_menu" id="mobile_log">
    ...
    <nav>
        ...
        <ul>
            ...
            <li><a href="javascript:void(0)" onclick="showPage('approve_guest.php')"id="appPay" class="page_navs" title="Approve payment"><i class="fas fa-users"></i> Onsite Registration</a></li>
            <li><a href="javascript:void(0)" onclick="showPage('approve_paid_guests.php')"id="appPay" class="page_navs" title="Approve payment"><i class="fas fa-users"></i> Approve Guests</a></li>
            <?php if($last_name == "Admin"){?>
