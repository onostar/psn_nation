<?php
    ...
    $get_filter = $connectdb->prepare("SELECT * FROM users WHERE attendance != 0 AND interest_group = :interest_group ORDER BY reg_date");
    $get_filter->bindValue("interest_group", $filter);
    $get_filter->execute();
?>
