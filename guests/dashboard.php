    ...
    <div class="cards" id="card0">
        <a href="javascript:void(0)">
            <div class="infos">
                ...
                <?php
                    $get_status = $connectdb->prepare("SELECT payment_status FROM users WHERE user_email = :user_email");
                    $get_status->bindvalue("user_email", $username);
                    $get_status->execute();
            ...
            <p> Events attended </p>
                ...
                <p>
                    <?php
                        ...
                        $get_event->bindValue("pharmacist", $user->reg_number);
                        $get_event->execute();
