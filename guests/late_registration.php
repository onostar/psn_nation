...
<meta charset="UTF-8">
    ...
    <title>Jewel city 2023 conference| Guest Late Registration</title>
    ...
    <main>
            <section class="reg_log">
                ...
                <div class="login_page" id="reg_form">
                    ...
                    ?>
                    <form action="../controller/register_guest.php" method="POST" enctype="multipart/form-data" class="form">
                    <div class="input">
                        <div class="data">
