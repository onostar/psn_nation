...
<head>
    ...
    <title>Jewel city 2023 conference| Guest Login</title>
    ...
    <main>
            <section class="reg_log">
                ...
                <div class="login_page">
                    ...
                    ?>
                    <form action="../controller/guest_login.php" method="POST">
                        <div class="data">
                            <label for="username">Enter email address</label>
                            <input type="email" name="username" id="username" placeholder="mail@example.com" required>
                        </div>
                        <div class="data">
                            <div class="pass">
                        ...
                        <div class="data">
                            <button type="submit" id="guest_login" name="guest_login">Sign in <i class="fas fa-sign-in-alt"></i></button>
